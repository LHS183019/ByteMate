...
- [x] 无法透过popup点开dashboard  @aidenlee2005 resolve
- [x] 在popup做的设定无法更新到后台  @LHS183019 resolve
- [x] 后端无法正常返回结果(qwen请求貌似发送不成功, deepseek返回格式与zhipu不统一，只有zhipu works) @Tort0iseZzz resolve
...
- [x] 后端返回结果无法正确加载入前端  @LHS183019 resolve
