...
> [!WARNING]
> **🚨 特别提醒 (v1.0.2 及之前版本用户)**
> 更新扩展时请**不要移除**旧版本，否则会导致做题记录丢失！
> 请务必查看 [📥 正确的更新方法](#方式一加载已解压的扩展程序推荐) 以保留您的数据。
...
| 类型       | 描述 |
| :--------- | :---------------------------- |
| ☁️ 新功能 | **云端同步**：支持多设备间同步做题进度和设置，自动合并数据防止丢失 |
| 🔧 优化 | 移除了 Dashboard 中易误触的重置按钮，增强数据安全性 |
| 🧪 质量 | 新增大量单元测试，确保核心逻辑稳定性 |
...
| 类型       | 描述 |
| :--------- | :---------------------------- |
| 🚀 新功能 | 支持更多 LLM 模型 (OpenAI, Gemini, Claude) |
| 🔧 优化 | 优化了模型响应解析和流式传输稳定性 |
